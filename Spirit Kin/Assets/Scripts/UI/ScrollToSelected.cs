...
public class ScrollToSelected : MonoBehaviour
{
    ...
    void UpdateScrollToSelected()
    {
        ...
        float above = currentScrollRectPosition - (m_SelectedRectTransform.rect.height *1.5f) + m_RectTransform.rect.height;
        float below = currentScrollRectPosition + (m_SelectedRectTransform.rect.height *1.5f);
